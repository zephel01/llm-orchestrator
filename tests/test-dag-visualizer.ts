...
import { SubtaskWithDependencies, TaskStatus, ConditionalDependency } from '../src/dependencies/types.js';
...
const mockConditionalSubtasks: SubtaskWithDependencies[] = [
  {
    id: 'deploy',
    description: 'Deploy to production',
    dependencies: ['build'],
  ...
  },
  {
    ...
    dependencies: [
      { taskId: 'deploy', condition: 'failure' as 'failure' }
    ] as ConditionalDependency[],
    status: TaskStatus.PENDING,
    assignedTo: 'agent-3'
  }
];
