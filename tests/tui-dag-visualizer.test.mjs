...
describe('DAGVisualizer', () => {
  describe('Construction', () => {
    it('should create a visualizer with default options', () => {
      ...
      expect(visualizer.options).toBeDefined();
    });
    ...
    it('should create a visualizer with custom options', () => {
      ...
      expect(visualizer).toBeDefined();
      expect(visualizer.options.width).toBe(100);
      expect(visualizer.options.showStatus).toBe(true);
    });
  });
  ...
  describe('Dependency Handling', () => {
    it('should correctly identify task dependencies', () => {
      ...
      const task2DependsOnTask1 = testSubtasks[1].dependencies.includes('task-1');
